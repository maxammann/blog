...
To test the TLS connection with the system certificate chain:
```bash
...
```
<sup>Note: If you see an error about reading the chain then fix the formatting of the chain: `sed 's/\r//g' telegraf.ca`</sup>
...
verify return:1
depth=0 CN = server21.integreat-app.de
verify return:1
---
Certificate chain
 0 s:/CN=server21.integreat-app.de
...
---
```
<sup>Note: `unable to get issuer certificate`</sup>


To verify a chain use:
```bash
